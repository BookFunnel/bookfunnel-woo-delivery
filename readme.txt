...
2. The Settings tab — connected state with webhook UID and email notification settings.
3. The Deliveries tab — view and manage all delivery notifications.
4. The order thank-you page showing a BookFunnel delivery confirmation message.
